...
for(int i=0;i<mAdapter.getCount();i++){
            ...
            addViewInLayout(child, i, null, true);        }        this.invalidate();    }    @Override    public void onItemClick(AdapterView<?> parent, View v, int position, long id) {        Log.d("MYEXAMPLES","Clicked an item!");    }}
```
